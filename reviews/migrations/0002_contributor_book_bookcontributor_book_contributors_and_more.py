    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phoneNumber', models.DateField(help_text='The contact phone number for the contributor.', max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('edition', models.CharField(help_text='The edition of the book.', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(help_text='The Book that this review is about.', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),
